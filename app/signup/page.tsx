        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
          ...
          <div className="space-y-2.5 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-zinc-700 bg-zinc-900 px-4 py-2.5 text-sm text-zinc-300 hover:border-zinc-500 hover:text-white transition-colors disabled:opacity-50"
            >
              <GoogleIcon />
          ...
          <p className="text-xs text-zinc-600 mt-5 text-center leading-relaxed">
            ...
            <Link href="/legal/terms" className="text-zinc-500 hover:text-zinc-300 transition-colors">Terms of Service</Link>{" "}
            and{" "}
            <Link href="/legal/privacy" className="text-zinc-500 hover:text-zinc-300 transition-colors">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </div>
